...
```{r}
vital_sign_sample %>%
  filter(encounterId==54043611) -> random
```
...
```{r}
vital_sign_sample %>%
  filter(encounterId==53104884) -> grouped_data1
...
```{r}
arrival_time1 <- encounter_sample$arrivalTime[encounter_sample$encounter_id==53104884]
...
```{r}
discharge_time1 <- encounter_sample$discharge_time[encounter_sample$encounter_id==53104884]
...
```{r}
vital_sign_sample %>%
  filter(encounterId==53203607) -> grouped_data2
...
The Patient arrived at:
```{r}
arrival_time2 <- encounter_sample$arrivalTime[encounter_sample$encounter_id==53203607]
...
The patient was discharged at:
```{r}
discharge_time2 <- encounter_sample$discharge_time[encounter_sample$encounter_id==53203607]
...
```{r}
vital_sign_sample %>%
  filter(encounterId==53069837) -> grouped_data3
...
The Patient arrived at:
```{r}
arrival_time3 <- encounter_sample$arrivalTime[encounter_sample$encounter_id==53069837]
...
The patient was discharged at:
```{r}
discharge_time3 <- encounter_sample$discharge_time[encounter_sample$encounter_id==53069837]
